    ...
    public partial class Migration1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Goods_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliversGoods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeliversGoods_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DeliversGoods_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DeliversGoods_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SendsGoods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SendsGoods_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SendsGoods_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SendsGoods_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "DeletedById",
                unique: true,
                filter: "[DeletedById] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliversGoods_CreatedById",
                table: "DeliversGoods",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_DeliversGoods_DeletedById",
                table: "DeliversGoods",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_DeliversGoods_GoodsId",
                table: "DeliversGoods",
                column: "GoodsId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliversGoods_UpdatedById",
                table: "DeliversGoods",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SendsGoods_CreatedById",
                table: "SendsGoods",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_SendsGoods_DeletedById",
                table: "SendsGoods",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_SendsGoods_RequestsId",
                table: "SendsGoods",
                column: "RequestsId");

            migrationBuilder.CreateIndex(
                name: "IX_SendsGoods_UpdatedById",
                table: "SendsGoods",
                column: "UpdatedById");
        }
