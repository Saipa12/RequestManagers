////const Splitting = require("");
////const gsap = require("wwwroot/js/gsap.min.js");
//import * as Splitting from "splitting";
////import * as splitting from "../../../js/splitting.min.js";
...
//    initialize(id) {
//        console.log("PhotoCard" + id);
//        this.DOM.el = document.getElementById(id);
//        console.log("1", this.DOM.el);
//        this.DOM.img = this.DOM.el.querySelector('.card__img');
//        console.log("2", this.DOM.img);
//        this.DOM.boxes = [...this.DOM.el.querySelectorAll('.card__box')];
//        console.log("3", this.DOM.boxes);

//        // For each box element, create a new CardBox instance and add it to cardBoxesArr.
//        this.DOM.boxes.forEach(boxEl => this.cardBoxesArr.push(new CardBox(boxEl)));
...
//        this.DOM.el.addEventListener('mouseenter', event => this.enter());
//        this.DOM.el.addEventListener('mouseleave', event => this.leave());
//    }
